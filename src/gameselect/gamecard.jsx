...
export function GameCard(gameData) {
    ...
    return (
        <>
         ...
         (
                <div>
                    <button className="async-game play-game" onClick={()=> {localStorage.setItem('currentGameId', currentGame.id);window.location.href = 'playgame';}}>
                        <div>
            ...
            (<div>
                <div className="async-game">
                    ...
                    <span>
                        <button className="rounded-button" onClick={()=>{acceptOrRejectGame(true, currentGame.id);}} id="acceptRequest">Accept</button>
